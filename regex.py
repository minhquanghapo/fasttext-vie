...
class regex:
    ...
    def run(self, data):
        s = self.detect_num.sub(u'', data) # replaced number to 1
        ...
        # s = self.detect_all_caps(u'', s)
        # s = self.detect_non_vnese.sub(u'', s)
...
if __name__ == '__main__':
    r = regex()
    s = u'bền quanghonag4334@gmail.com năm adsd2 2323 '
    ss = r.run(s)
    print ss